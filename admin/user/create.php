  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="box">
            ...
            <!-- /.box-header -->
           <form class="form-horizontal" action="proses_tambah.php" method="POST" enctype="multipart/form-data">
              <div class="box-body">
                <div class="form-group">
                  <label for="nama" class="col-sm-2 control-label">Nama User</label>
                  <div class="col-sm-10">
                  <input type="text" class="form-control" id="nama" placeholder="Masukan Nama User" name="nama" required>
                  </div>
                </div>
              </div>
              <div class="box-body">
